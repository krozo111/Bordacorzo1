    ...
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <form
          id="form1"
          name="contact"
          className="lg:w-1/3 md:w-1/2 border-2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 bg-gradient-to-b from-gray-50 to-green-200"
        >
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              className="w-3/4 bg-gray-100  h-10  border-b-2 ml-4 "
          ...
          <div className="relative mb-4">
            ...
            <textarea
              id="message"
              name="message"
              className="w-5/6 bg-gray-100 border-current h-32 py-1 px-3 ml-4 resize-none"
          ...
          <button
            type="submit"
            form="form1"
            className="m-4 w-min  text-white bg-green-400 border-0 py-2 px-6 focus:outline-none hover:bg-green-500 rounded text-lg"
          >
            Enviar
          </button>
        </form>
